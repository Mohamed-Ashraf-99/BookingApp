        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Complains_Hotels_HotelId",
                        column: x => x.HotelId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Ambience = table.Column<int>(type: "int", nullable: true),
                    Cuisine = table.Column<int>(type: "int", nullable: true),
                    DietaryOptions = table.Column<int>(type: "int", nullable: true),
                    OpenFor = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MealsPackage", x => new { x.MealsId, x.PackagesId });
                    table.ForeignKey(
                        name: "FK_MealsPackage_Meals_MealsId",
                        column: x => x.MealsId,
                        principalTable: "Meals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MealsPackage_Packages_PackagesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PackageRoomFacilities", x => new { x.PackagesId, x.RoomFacilitiesId });
                    table.ForeignKey(
                        name: "FK_PackageRoomFacilities_Packages_PackagesId",
                        column: x => x.PackagesId,
                        principalTable: "Packages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PackageRoomFacilities_RoomFacilities_RoomFacilitiesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MealsPackage_PackagesId",
                table: "MealsPackage",
                column: "PackagesId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PackageRoomFacilities_RoomFacilitiesId",
                table: "PackageRoomFacilities",
